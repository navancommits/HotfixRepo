...
$XConnectSiteName = "sc101nksrxconnect.dev.local"
# The Sitecore site instance name.
$SitecoreSiteName = "sc101nksrsc.dev.local"
# Identity Server site name
$IdentityServerSiteName = "sc101nksridentityserver.dev.local"
...
$SolrRoot = "C:\Solr\solr101tsolr-8.4.0"
# The Name of the Solr Service.
$SolrService = "solr101tsolr-8.4.0"
# The DNS name or IP of the SQL Instance.
$SqlServer = "(local)"
# A SQL user with sysadmin privileges.
$SqlAdminUser = "sa"
# The password for $SQLAdminUser.
$SqlAdminPassword = "ggffg"
...
#$XConnectPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 10.1.3 rev. 009139 (CUMULATIVE DELTA WDP XP0 packages)\Sitecore * rev. * (OnPrem)_xp0xconnect.cumulative.delta.scwdp.zip").FullName
# The path to the Sitecore Package to Deploy.
#$SitecorePackage = (Get-ChildItem "$SCInstallRoot\Sitecore 10.1.3 rev. 009139 (CUMULATIVE DELTA WDP XP0 packages)\Sitecore * rev. * (OnPrem)_single.cumulative.delta.scwdp.zip").FullName
# The path to the Identity Server Package to Deploy.
#$IdentityServerPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 10.1.3 rev. 009139 (CUMULATIVE DELTA WDP XP0 packages)\Sitecore.IdentityServer * rev. * (OnPrem)_identityserver.cumulative.delta.scwdp.zip").FullName

$XConnectPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 10.1.3 rev. 009139 (DELTA WDP XP0 packages)\Sitecore * rev. * (OnPrem)_xp0xconnect.delta.scwdp.zip").FullName
# The path to the Sitecore Package to Deploy.
$SitecorePackage = (Get-ChildItem "$SCInstallRoot\Sitecore 10.1.3 rev. 009139 (DELTA WDP XP0 packages)\Sitecore * rev. * (OnPrem)_single.delta.scwdp.zip").FullName
# The path to the Identity Server Package to Deploy.
$IdentityServerPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 10.1.3 rev. 009139 (DELTA WDP XP0 packages)\Sitecore.IdentityServer * rev. * (OnPrem)_identityserver.delta.scwdp.zip").FullName
...
$ClientSecret = "fe6g2c5+YBGh5180qjB6N91nKGNn+gvgS0n51ixHnNY="
